...
const SideBar = () => {
	...
	useEffect(() => {
		if (!avatarFile) {
			setAvatarFile(avatarRandom);
		}
	}, [avatarFile]);

	return (
		<div className="bg-white mt-32 h-screen md:block shadow-xl px-3 w-30 md:w-60 lg:w-60 overflow-x-hidden transition-transform duration-300 ease-in-out">
